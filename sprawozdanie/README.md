...
W tym folderze znajduje się przykładowy raport LaTeX (`main.tex`), który dołącza opis algorytmu A2C z pliku `../opis_a2c/opis_a2c.tex`.
...
Polecenie to utworzy plik `main.pdf`. Czasami wymagane jest dwukrotne uruchomienie kompilacji, aby poprawnie wygenerować spisy treści lub odnośniki (jeśli są używane).
